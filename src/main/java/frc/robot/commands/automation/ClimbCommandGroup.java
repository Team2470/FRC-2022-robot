...
import frc.robot.commands.climber.BackClimbAngleCommand;
import frc.robot.commands.climber.MoveFrontClimberCommand;
...
public class ClimbCommandGroup extends SequentialCommandGroup {
  ...
  public ClimbCommandGroup(FrontClimber frontClimber, BackClimber backClimber) {
    addCommands(
        new SelectCommand(
            Map.ofEntries(
                // Starting Config
